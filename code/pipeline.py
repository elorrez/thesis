...
#
# The original dataset only has 562 pixels in this area (lat: -10, 10, lon: 0, 40.6). To end up with the same pixels,
...
inpath = 'C:/EVA/THESIS/data/EVI_time_series_intersection/'
